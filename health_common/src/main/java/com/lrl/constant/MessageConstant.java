...
public class MessageConstant {
    ...
    public static final String SERVICE_ERROR =
            "服务器异常,请稍后再试";
    public static final String FIND_ITEMS_ERROR =
            "查找对应的选择项失败";
    public static final String EDIT_PACKAGE_SUCCESS = "编辑套餐成功";
    public static final String EDIT_PACKAGE_FAILED = "编辑套餐失败";
    public static final String EDIT_ORDERSETTING_SUCCESS = "设置预约人数成功";
    public static String EDIT_ORDERSETTING_FAILED = "设置预约人数失败";
    public static final String PARSE_DATE_ERROR = "填写的日期格式有误";
    public static final String RESEND_VALIDATECODE = "短信已经发送，请注意查收";
    public static final String VALIDATECODE_TIMEOUT_OR_NOT_SENDCODE = "验证码过期或者未发送验证码，请重新获取验证码";
    public static final String ERROR_TELEPHONE_INPUT = "输入的电话好码有误";
    public static final String ODER_FAILED_MAYBE_ERROR_DATE = "预约错误，请检查预约数据正确性";
    public static final String ILLEGAL_INPUT = "数据非法，请重试";
    public static final String GET_PACKAGE_REPORT_SUCCESS = "获取套餐统计信息成功";
